...
export function StarRating({ value, onChange, readonly = false, size = "md", className }: StarRatingProps) {
  ...
  return (
    <div className={cn("flex items-center gap-0.5", className)} role="group" aria-label={`Rating: ${value} out of 5`}>
      {[1, 2, 3, 4, 5].map((star) => {
        ...
        return (
          ...
          >
            <svg className={cn(sizes[size], filled ? "text-yellow-400" : "text-gray-300")} fill="currentColor" viewBox="0 0 20 20">
